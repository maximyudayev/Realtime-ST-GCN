...
sbatch --parsable --time=00:30:00 --job-name="debug_${TIMESTAMP}_pkummd_stgcn" --ntasks-per-node=20 --gpus-per-node=5 pkummd_v100.slurm --config '/data/leuven/341/vsc34153/rt-st-gcn/config/pku-mmd/as_is/stgcn_vsc.json'
